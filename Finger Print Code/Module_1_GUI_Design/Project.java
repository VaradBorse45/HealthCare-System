...
//===================================================================================================================================================================
	...
	public static void method()
	{
		...
		verify.addActionListener(new ActionListener()
		{
			...
			{
				frame.setVisible(false);
			  JOptionPane.showMessageDialog(null,"Device Module Code Remaining","Device Not Found",JOptionPane.ERROR_MESSAGE);

//				RecogFace f=new RecogFace("Patient Identify",new JFrame());
//			f.setVisible(true);
			}
		});
