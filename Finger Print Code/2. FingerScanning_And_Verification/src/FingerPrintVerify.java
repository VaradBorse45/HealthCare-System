...
public class FingerPrintVerify extends Applet 
{
	...
	public void findMatch() 
	{
		...
		for(int k=0;k<l.length;k++)
		{
		  ...
		  if(bMatch == true)
		  {
			JOptionPane.showMessageDialog(f1, "Matched.","",JOptionPane.INFORMATION_MESSAGE);
			break;
		  }
		}
		if(bMatch == false)
		{
		    JOptionPane.showMessageDialog(f1, "Not Matched.","",JOptionPane.ERROR_MESSAGE);
		}
		init();
