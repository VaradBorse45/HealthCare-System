...
public class FingerPrintVerify extends JFrame
{
	...
	public Image getFpImageToDisplay() 
	{
		...
		{
			//return new ImageIcon(FingerPrintVerify.class.getResource("/Images/Blank.jpg")).getImage();			
		}
	...
	class CaptureCallbackImpl implements IFingerprintCaptureCallbackAPI
	{
		...
		{		
			...
			System.out.println("Capture Byte Done");
	...
	{
		String path=Login.FingerDBpath;
		...
		if(bMatch == false)
		{
				JOptionPane.showMessageDialog(btnCapture, "Not Matched   or \nInproper Scan","",JOptionPane.ERROR_MESSAGE);
		}
		else
		{
			// Project.method(file);
			IndentifyPatient.result = file;
		}
